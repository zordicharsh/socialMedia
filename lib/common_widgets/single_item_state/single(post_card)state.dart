...
class SingleImagePostCardItemState extends StatefulWidget {
  ...
  @override
  State<SingleImagePostCardItemState> createState() =>
      _SingleImagePostCardItemStateState();
}

class _SingleImagePostCardItemStateState
    extends State<SingleImagePostCardItemState> {
  /*List randomImages = [
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(
            height: widget.postdata['type'] == 'image'
