...
import '../like_animation_widget/like_animation_widget.dart';
...
class SinglePopupDialogState extends StatefulWidget {
  ...
  final int index;
  final QuerySnapshot<Map<String, dynamic>>? postdata;
...
class _SinglePopupDialogStateState extends State<SinglePopupDialogState> {
  ...
  void initState() {
    ...
    videoPlayerController = CachedVideoPlayerController.network(
        widget.postdata!.docs[widget.index]['posturl'].toString(),
  ...
  Widget _createPopupContent(int index, QuerySnapshot<Map<String, dynamic>>? postdata) => Container(
        ...
        leading: profileurl != ""
            ...
            : CircleAvatar(
                ...
                child: CircleAvatar(
                  ...
                  radius: 14,
                  child:
                      Icon(Icons.person, color: Colors.black.withOpacity(0.5),size:22),
                ),
              ),
        title: Text(
          username,
