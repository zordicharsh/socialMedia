        ...
        try{
          ...
          if(image != null) {
            ...
            await uploadTask.whenComplete(() async{
              UserPostImageModel userPostImageModel = await UserPostImageModel(Username: userdata.Username.toString(), Uid: UserAuth!.uid.toString(), Likes: [], PostUrl: downloadURL,datetime: Timestamp.now());
              var res = await FirebaseFirestore.instance.collection("UserPost")
                  .doc()
                  .set(userPostImageModel.tomap());
            });
            emit(LoadingGoState());
            print("7");
