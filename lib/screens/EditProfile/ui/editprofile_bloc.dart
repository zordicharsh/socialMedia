...
class EditprofileBloc extends Bloc<EditProfileEvent, EditProfileState> {
  ...
  Future<void> editProfileDataPassEvent(EditProfileDataPassEvent event, Emitter<EditProfileState> emit) async {
  ...
  void UpdateProfile(String url,String name,String username,String bio) async {
    ...
    await FirebaseFirestore.instance
        ...
        .update({"profileurl": url,"bio": bio,"name":name,"username":username});
    print("UNDER DOWNLOD Successsssssssssssssssssssssssssssssssssss");
  }
/////////////////////////////////////////////////////// URL NULL VALA METHODE ////////////////////////////////////////////////////
  Future<void> editProfileDataPassEvent2(EditProfileDataPassEvent2 event, Emitter<EditProfileState> emit) async {
    await FirebaseFirestore.instance
        .collection('RegisteredUsers')
        .doc(FirebaseAuth.instance.currentUser?.uid)
        .update({"profileurl": event.kuchnahi,"bio": event.bio,"name":event.name,"username":event.username});
    print("nullllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll");
  }

  Future<void> editProfilUserNameCheckEvent(EditProfilUserNameCheckEvent event, Emitter<EditProfileState> emit) async {
