...
import 'package:socialmedia/screens/registration/bloc/registration_event.dart';
import 'package:socialmedia/screens/registration/bloc/registration_state.dart';
...
class RegistrationBloc extends Bloc<RegistrationEvents, RegistrationStates> {
  ...
  FutureOr<void> clickOnLightButton(ClickOnVisibilityButton event,
  ...
  FutureOr<void> clickOnSignUpButton(ClickOnSignUpButton event,
      Emitter<RegistrationStates> emit) async {
    try {
