...
import 'package:socialmedia/screens/login/ui/loginui.dart';
...
class _EmailVerificationScreenState extends State<EmailVerificationScreen>
  ...
  Future<void> checkEmailVerified() async {
    ...
    if (isEmailVerified) {
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const PopScope(canPop: false,child:LoginUi() ,) ));
      timer?.cancel();
    }
  }
