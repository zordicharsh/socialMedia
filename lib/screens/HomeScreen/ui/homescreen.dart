      ...
      body:Builder(builder: (context) {
        if(value == "post"){
          ...
          return StreamBuilder(
            stream: FirebaseFirestore.instance.collection("UserPost").where('uid',whereIn: followingList).where('type',isEqualTo: "video").orderBy("uploadtime",descending: true).snapshots(),
            builder: (context, snapshot) {
              if (snapshot.hasData) {
