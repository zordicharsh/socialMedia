...
class DrawerBloc extends Bloc<DrawerEvent, DrawerState> {
  ...
  FutureOr<void> publicPrivateEvent(
      PublicPrivateTrueEvent event, Emitter<DrawerState> emit) {
    bool CheckBloc;
  ...
  FutureOr<void> publicPrivateFalseEvent(
      PublicPrivateFalseEvent event, Emitter<DrawerState> emit) {}
  ...
  Future<void> firstCheckAccTypeEvent(
      FirstCheckAccTypeEvent event, Emitter<DrawerState> emit) async {
    String? TypessCheck;
    bool check;
