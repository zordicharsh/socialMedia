...
class SearchedProfileReelSection extends StatefulWidget {
  const SearchedProfileReelSection({
    super.key, required this.searchedUserId,
  });
final String searchedUserId;
  @override
  State<SearchedProfileReelSection> createState() => _SearchedProfileReelSectionState();
}

class _SearchedProfileReelSectionState extends State<SearchedProfileReelSection> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection('UserPost').where('uid',isEqualTo: widget.searchedUserId).where('type',isEqualTo:'video').orderBy('uploadtime',descending: true).snapshots(),
